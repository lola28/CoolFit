...
kaka = User.create!(
  ...
  professional: false,
  avatar: "Coolfit/n-COLLEGEHUMOR-large570_aiiqx7.jpg"
  )
alice = User.create!(
  first_name: "Alice",
  ...
  professional: false,
  avatar: "Coolfit/photos-cannes-2019-monica-bellucci-fait-crepiter-les-flashs-avec-un-decollete-hypnotisant_j1nke2.jpg"
  )
vlad = User.create!(
  first_name: "Vladimir",
  ...
  professional: false,
  avatar: "Coolfit/brad-pitt-in-wrangler-long-sleeve-with-belted-jeans-all-people-photo-u1_ujszop.jpg"
  )
...
frankie = User.create!(
  ...
  professional: true,
  avatar: "Coolfit/fonda_jd59nt.png"
  )
